...
export const handleGetMyImages = (param) => ({
    ...
    payload: axios({
        method: 'GET',
        url: `https://positive-toon-rest-api.herokuapp.com/api/v1/user/${param.user}/webtoon/${param.webtoon}/episode/${param.episode}/images`,
        headers: {
...
export const handleAddMyImages = (param) => ({
    ...
    payload: axios({
        method: 'POST',
        url: `https://positive-toon-rest-api.herokuapp.com/api/v1/user/${param.user}/webtoon/${param.webtoon}/episode/${param.episode}/image`,
        headers: {
            Authorization: `bearer ${param.token}`
        },
        data: param.data
